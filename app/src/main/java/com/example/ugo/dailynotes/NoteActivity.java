package com.example.ugo.dailynotes;
...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_POSITION =
            "com.example.ugo.dailynotes.NOTE_POSITION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create an adapter to load each item on the list
    ...
    private void sendEmail() {
        ...
        String text = "Checkout what I learnt in the pluralsight course \"" + courses.getTitle() + "\"\n"
